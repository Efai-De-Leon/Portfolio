...
import com.example.efaideleon.super_mario_bros.Block;
import com.example.efaideleon.super_mario_bros.Boo;
import com.example.efaideleon.super_mario_bros.BrickBlock;
import com.example.efaideleon.super_mario_bros.Coin;
import com.example.efaideleon.super_mario_bros.FireFlower;
import com.example.efaideleon.super_mario_bros.Floor;
import com.example.efaideleon.super_mario_bros.Goomba;
...
public class LevelOne extends Level{
    ...
    Floor floor4;
    Floor floor5;
    com.example.efaideleon.super_mario_bros.WorldView worldView;
    ...
    QuestionBlock questionBlock3;
    ColorBlocks colorBlocks1;
    Cloud cloud1;
    Goal goal1;
    Bush bush1;
    FireFlower fireFlower2;
    private boolean resetLevelOne = false;
    private boolean levelOneRunning = true;
    ...
    Timer timer;
    public LevelOne(com.example.efaideleon.super_mario_bros.WorldView wv)
    {

        worldView = wv;
        floor1 = new Floor(1780,1235,worldView.getFloor(), 780,205);
        floor2 = new Floor(1000,1235,worldView.getFloor(), 780,205);
        floor3 = new Floor(220,1235,worldView.getFloor(), 780,205);
        floor4 = new Floor(-760,1235,worldView.getFloor(), 780,205);
        floor5 = new Floor(-1540,1235,worldView.getFloor(), 780,205);
        ...
        fireFlower = new FireFlower(1020,800,worldView.getFireFlower());
        gravity = new Gravity();

        block = new Block(-1200,1145,worldView.getBlock());
        goomba = new Goomba(500,1145,worldView.getGoomba());
        coin = new Coin(-400,800,worldView.getCoin());
        coin1 = new Coin(-500,800,worldView.getCoin());
        coin2 = new Coin(-600,800,worldView.getCoin());
        coin3 = new Coin(-700,800,worldView.getCoin());
        coin4 = new Coin(-800,800,worldView.getCoin());
        coin5 = new Coin(-900,800,worldView.getCoin());
        coin6 = new Coin(1010,400,worldView.getCoin());
        coin7 = new Coin(-110,780,worldView.getCoin());


        mushroom2 = new com.example.efaideleon.super_mario_bros.Mushroom(-90,780,worldView.getMushroom());
        piranhaPlant = new com.example.efaideleon.super_mario_bros.PiranhaPlant(440,1035,worldView.getPiranhaPlant());
        pipe = new Pipe(400,1035,worldView.getPipe());
        boo = new Boo(-700,1100,worldView.getBoo());
        questionBlock = new com.example.efaideleon.super_mario_bros.QuestionBlock(-120,780,worldView.getQuestionBlock(),coin7);

        questionBlock2 = new com.example.efaideleon.super_mario_bros.QuestionBlock(1000,800,worldView.getQuestionBlock(),fireFlower);
        questionBlock3 = new com.example.efaideleon.super_mario_bros.QuestionBlock(1000,400,worldView.getQuestionBlock(),coin6);
        brickBlock = new BrickBlock(880,800,worldView.getBrickBlock());
        brickBlock2 = new BrickBlock(1120,800,worldView.getBrickBlock());

        cloud1 = new Cloud(100,300,worldView.getCloud());
        colorBlocks1 = new ColorBlocks(300,535,worldView.getColorBlocks());
        bush1 = new Bush(600,1135,worldView.getBush());
        goal1 = new Goal(-1100,800, worldView.getGoal());

        fireFlowerArrList.add(fireFlower);
        cloudArrList.add(cloud1);
        colorBlocksArrList.add(colorBlocks1);
        bushArrList.add(bush1);
        goalArrList.add(goal1);
        questionBlockArrList.add(questionBlock3);
        ...
        pipeArrList.add(pipe);
        booArrList.add(boo);
        piranhaPlantArrList.add(piranhaPlant);
        ...
        coinArrList.add(coin6);
        coinArrList.add(coin7);
    ...
    public boolean isLevelOneRunning() {
        return levelOneRunning;
    }
    ...
    public boolean isResetLevelOne() {
        return resetLevelOne;
    }

    public void setResetLevelOne(boolean resetLevelOne) {
        this.resetLevelOne = resetLevelOne;
    }
    ...
    public void resetPositions()
    {
        ...
        fireFlower.setLocationX(1020);
        fireFlower.setLocationY(800);
        ...
        coin6.setLocationX(1010);
        coin6.setLocationY(400);
        coin7.setLocationX(-110);
        coin7.setLocationY(780);
