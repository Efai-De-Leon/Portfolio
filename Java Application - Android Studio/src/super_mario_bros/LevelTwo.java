...
public class LevelTwo extends Level{
    ...
    Cloud cloud1;
    EyeBushes eyeBushes1;
    Bush bush1;
    Goal goal1;
    private boolean resetLevelTwo = false;
    private boolean levelTwoRunning = false;
    ...
    public LevelTwo(WorldView wv)
    {

        worldView = wv;
        floor1 = new Floor(1780,1235,worldView.getGrassFloor(), 780,205);
        floor2 = new Floor(1000,1235,worldView.getGrassFloor(), 780,205);
        floor3 = new Floor(220,1235,worldView.getGrassFloor(), 780,205);
        floor4 = new Floor(-560,1235,worldView.getGrassFloor(), 780,205);
        floor5 = new Floor(-1540,1235,worldView.getGrassFloor(), 780,205);
        ...
        fireFlower = new FireFlower(20,780,worldView.getFireFlower());
        gravity = new Gravity();

        block = new Block(-500,1145,worldView.getBlock());
        goomba = new Goomba(500,1145,worldView.getGoomba());
        coin = new Coin(1000,1140,worldView.getCoin());
        coin1 = new Coin(900,1140,worldView.getCoin());
        coin2 = new Coin(800,1140,worldView.getCoin());
        coin3 = new Coin(700,1140,worldView.getCoin());
        coin4 = new Coin(600,1140,worldView.getCoin());
        coin5 = new Coin(500,1140,worldView.getCoin());
        ...
        piranhaPlant = new com.example.efaideleon.super_mario_bros.PiranhaPlant(-160,1035,worldView.getPiranhaPlant());
        pipe = new Pipe(-200,1035,worldView.getPipe());
        boo = new Boo(-700,1100,worldView.getBoo());
        questionBlock = new com.example.efaideleon.super_mario_bros.QuestionBlock(0,780,worldView.getQuestionBlock(),fireFlower);
        ...
        eyeBushes1 = new EyeBushes(1400,535,worldView.getEye_bushes());
        bush1 = new Bush(1000,1135,worldView.getBush());
        goal1 = new Goal(-1100,800, worldView.getGoal());


        eyeBushesArrList.add(eyeBushes1);
    ...
    public boolean isLevelTwoRunning() {
        return levelTwoRunning;
    }
    ...
    public void setLevelTwoRunning(boolean levelTwoRunning) {
        this.levelTwoRunning = levelTwoRunning;
    }

    public boolean isResetLevelTwo() {
        return resetLevelTwo;
    }

    public void setResetLevelTwo(boolean resetLevelTwo) {
        this.resetLevelTwo = resetLevelTwo;
    }
